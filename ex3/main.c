...
Output: int
The function operation: Calc the amount of moeny the bank will have
************************************************************************/
int AmountToBank(int totalPlayers, int playersRemoved, int bank, int charity) {
...
Output: void
The function operation: Print the inputed letter the amount of time inpputed in the same line
************************************************************************/
void PrintRepeate(int amount, char letter) {
    int i = 0;
    for (;i < amount; i++) {
